...
@SuppressWarnings("restriction") // Required for internal JDT interfaces
public class LocalLlamaProposalComputer implements IJavaCompletionProposalComputer {
	...
	public List<ICompletionProposal> computeCompletionProposals(ContentAssistInvocationContext context,
		...
		return LocalLlamaContentAssistProcessor.generateProposals(prefix, offset);
	}
