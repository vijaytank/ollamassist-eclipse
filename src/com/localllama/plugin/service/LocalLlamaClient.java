...
public class LocalLlamaClient {
	...
	public static void streamingQuery(List<ChatMessage> messages, String model, Consumer<String> chunkCallback,
			Runnable doneCallback, Consumer<String> errorCallback) {
