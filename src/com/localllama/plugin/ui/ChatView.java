...
import com.localllama.plugin.service.LocalLlamaClient; // Import LocalLlamaClient

public class ChatView extends ViewPart {

    public static final String ID = "com.localllama.plugin.ui.ChatView";

    private List<LocalLlamaClient.ChatMessage> conversationHistory; // Conversation history list
    ...
    public void createPartControl(Composite parent) {
        ...
        conversationHistory = new ArrayList<>(); // Initialize conversation history
 ...
 chatHistory.append("\n");
    ...
    private void queryOllama(String prompt) {
        ...
        String fullPrompt = context + prompt;        LocalLlamaQueryUtil.asyncQuery(fullPrompt, model, response -> {
